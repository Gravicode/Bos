...
namespace E2ETest
{
    public class HealthCheckTests
    {
        ...
        public async Task ServiceWithoutLivenessReadinessShouldDefaultToReadyTests()
        {
            ...
            var projectFile = new FileInfo(Path.Combine(projectDirectory.DirectoryPath, "bos-none.yaml"));
        ...
        public async Task ServiceWithoutLivenessShouldDefaultToHealthyTests()
        {
            ...
            var projectFile = new FileInfo(Path.Combine(projectDirectory.DirectoryPath, "bos-readiness.yaml"));
            var outputContext = new OutputContext(_sink, Verbosity.Debug);
            var application = await ApplicationFactory.CreateAsync(outputContext, projectFile);
        ...
        public async Task ServiceWithoutReadinessShouldDefaultToReadyWhenHealthyTests()
        {
            ...
            var projectFile = new FileInfo(Path.Combine(projectDirectory.DirectoryPath, "bos-liveness.yaml"));
            var outputContext = new OutputContext(_sink, Verbosity.Debug);
            var application = await ApplicationFactory.CreateAsync(outputContext, projectFile);
        ...
        public async Task ReadyServiceShouldBecomeHealthyWhenReadinessFailsTests()
        {
            ...
            var projectFile = new FileInfo(Path.Combine(projectDirectory.DirectoryPath, "bos-all.yaml"));
            var outputContext = new OutputContext(_sink, Verbosity.Debug);
            var application = await ApplicationFactory.CreateAsync(outputContext, projectFile);
        ...
        public async Task ProxyShouldNotProxyToNonReadyReplicasTests()
        {
            ...
            var projectFile = new FileInfo(Path.Combine(projectDirectory.DirectoryPath, "bos-proxy.yaml"));
            var outputContext = new OutputContext(_sink, Verbosity.Debug);
            var application = await ApplicationFactory.CreateAsync(outputContext, projectFile);
        ...
        public async Task IngressShouldNotProxyToNonReadyReplicasTests()
        {
            ...
            var projectFile = new FileInfo(Path.Combine(projectDirectory.DirectoryPath, "bos-ingress.yaml"));
            var outputContext = new OutputContext(_sink, Verbosity.Debug);
            var application = await ApplicationFactory.CreateAsync(outputContext, projectFile);
        ...
        private void SetReplicasInitialState(BosHost host, bool? healthy, bool? ready, string[]? services = null)
        {
            if (services == null)
            {
