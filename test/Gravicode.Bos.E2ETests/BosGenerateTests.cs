...
namespace E2ETest
{
    public class BosGenerateTests
    {
        private readonly ITestOutputHelper output;
        private readonly TestOutputLogEventSink sink;

        public BosGenerateTests(ITestOutputHelper output)
        {
            this.output = output;
        ...
        public async Task Generate_DirectDependencyForEnvVars()
        {
            ...
            var projectFile = new FileInfo(Path.Combine(projectDirectory.DirectoryPath, "results", "bos.yaml"));
