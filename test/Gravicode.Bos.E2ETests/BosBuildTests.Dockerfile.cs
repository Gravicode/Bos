...
namespace E2ETest
{
    ...
    public partial class BosBuildTests
    {
        [ConditionalFact]
        [SkipIfDockerNotRunning]
        public async Task BosBuild_SinglePhase_GeneratedDockerfile()
        {
        ...
        [ConditionalFact]
        [SkipIfDockerNotRunning]
        public async Task BosBuild_SinglePhase_ExistingDockerfile()
        {
            var projectName = "single-phase-dockerfile";
            var environment = "production";
            var imageName = "test/single-phase-dockerfile";
        ...
        [ConditionalFact]
        [SkipIfDockerNotRunning]
        public async Task BosBuild_SinglePhase_ExistingDockerfileWithBuildArgs()
        {
        ...
        [ConditionalFact]
        [SkipIfDockerNotRunning]
        public async Task BosBuild_SinglePhase_ExistingDockerfileWithBuildArgsDuplicateArgs()
        {
            var projectName = "single-phase-dockerfile-args";
            var environment = "production";
            var imageName = "test/web";
        ...
        [ConditionalFact]
        [SkipIfDockerNotRunning]
        public async Task BosBuild_SinglePhase_ExistingDockerfileWithBuildArgsMultiArgs()
        {
        ...
        [ConditionalFact]
        [SkipIfDockerNotRunning]
        public async Task BosBuild_MultipleTargetFrameworks_CliArgs()
        {
        ...
        [ConditionalFact]
        [SkipIfDockerNotRunning]
        public async Task BosBuild_MultipleTargetFrameworks_YamlBuildProperties()
        {
            var projectName = "multi-targetframeworks";
            var environment = "production";
            var imageName = "test/multi-targetframeworks";
