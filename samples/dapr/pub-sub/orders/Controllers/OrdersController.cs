...
namespace orders.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task PlaceOrder(Order order, [FromServices] DaprClient dapr, [FromServices] ILogger<OrdersController> logger)
        {
            ...
            var state = await dapr.GetStateEntryAsync<InventoryState>("statestore", order.ProductId.ToString());
            ...
            await dapr.PublishEventAsync("pubsub", "orderprocessed", confirmation);
