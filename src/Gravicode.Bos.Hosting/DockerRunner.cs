    ...
    public class DockerRunner : IApplicationProcessor
    {
        ...
        public async Task StartAsync(Application application)
        {
            ...
            foreach (var service in application.Services.Values)
            {
                ...
                var proxyContainer = new DockerRunInfo($"mcr.microsoft.com/dotnet/sdk:6.0", "dotnet Gravicode.Bos.Proxy.dll")
                {
                ...
                var proxyLocation = Path.GetDirectoryName(typeof(Gravicode.Bos.Proxy.Program).Assembly.Location);
            ...
            {
                dockerNetwork = "bos_network_" + Guid.NewGuid().ToString().Substring(0, 10);
