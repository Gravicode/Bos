...
using static Gravicode.Bos.Hosting.Diagnostics.WellKnownEventSources;

namespace Gravicode.Bos.Hosting.Diagnostics
{
        ...
        public void Collect(ReplicaInfo replicaInfo, CancellationToken cancellationToken)
        {
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                void StopSession()
                {
                    ...
                    // If the process has already exited, a ServerNotAvailableException will be thrown.
                    // This can always race with bos shutting down and a process being restarted on exiting.
