...
namespace Gravicode.Bos.Extensions.Dapr
{
    internal sealed class DaprExtension : Extension
    {
        ...
        {
            // If we're getting called then the user configured dapr in their bos.yaml.
            ...
            if (context.Operation == ExtensionContext.OperationKind.LocalRun)
            {
                ...
                foreach (var project in services)
                {
                    ...
                    // See https://github.com/dotnet/bos/issues/260
                    //
